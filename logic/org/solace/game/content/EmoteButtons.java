...
public class EmoteButtons {
     ...
     */
    private static final int YES = 855,
            NO = 856,
            THINK = 857,
            BOW = 858,
            ANGRY = 859,
    ...
    public static void handle(Player player, int actionButtonId) {
        switch (actionButtonId) {
            case 168:
                performAnimation(player, YES);
                break;
            case 169:
                performAnimation(player, NO);
                break;
            case 162:
                performAnimation(player, THINK);
                break;
            case 164:
                performAnimation(player, BOW);
                break;
            case 165:
                performAnimation(player, ANGRY);
                break;
            case 161:
                performAnimation(player, CRY);
                break;
            case 170:
                performAnimation(player, LAUGH);
                break;
            case 171:
                performAnimation(player, CHEER);
                break;
            case 163:
                performAnimation(player, WAVE);
                break;
            case 167:
                performAnimation(player, BECKON);
                break;
            case 172:
                performAnimation(player, CLAP);
                break;
            case 166:
                performAnimation(player, DANCE);
                break;
            case 52050:
                performAnimation(player, PANIC);
                break;
            case 52051:
                performAnimation(player, JIG);
                break;
            case 52052:
                performAnimation(player, SPIN);
                break;
            case 52053:
                performAnimation(player, HEADBANG);
                break;
            case 52054:
                performAnimation(player, JOYJUMP);
                break;
            case 52055:
                performAnimation(player, RASPBERRY);
                break;
            case 52056:
                performAnimation(player, YAWN);
                break;
            case 52057:
                performAnimation(player, SALUTE);
                break;
            case 52058:
                performAnimation(player, SHRUG);
                break;
            case 43092:
                performAnimation(player, BLOWKISS);
                break;
            default:
                handleLockedEmotes(player, actionButtonId);
                break;
        }
    }
